...
const transformer = (fileInfo, { j }) => {
    ...
    specifiers
        ...
        .replaceWith(j.importSpecifier(j.identifier('toast2'), j.identifier('toast')));
    // replace Cascader with Cascader2 in the import
    specifiers
        .find(j.ImportSpecifier, {
        imported: { name: 'Cascader' },
    })
        .replaceWith(j.importSpecifier(j.identifier('Cascader2'), j.identifier('Cascader')));
